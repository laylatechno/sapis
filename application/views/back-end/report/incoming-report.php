...
<div class="main-content">
        ...
        <div class="row d-print-none">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Laporan Surat Masuk</h4>
                        ...
                        <div class="row">
                          <div class="container">
                            <form id="form" class="form-horizontal needs-validation my-2" action="javascript:void(0)" method="post" novalidate>
                              ...
                              <div class="form-group">
                                <label>Unit Penerima (Boleh dikosongkan) </label>
                    ...
                    <div>
                        <div class="row">
                            <div class="col-lg-9 col-sm-8">
                                <div  class="p-4">
                                    <h5 class="text-primary">Mencetak Laporan Surat Masuk</h5>
                                    <p class="text-justify">Halaman ini memungkinkan anda untuk mencetak Laporan Surat Masuk berdasarkan tanggal yang ditentukan. Laporan akan tampil setelah anda mengklik <strong>Tamplikan</strong>, pastikan data telah tampil sebelum Anda mencetak Laporan. Untuk melakukan merubah informasi Logo dan Instansi pada Laporan surat, Anda bisa mmengubahnya pada menu <strong>Pengaturan Aplikasi</strong>. Berikut adalah cara melakukan Cetak Laporan.</p>

                                    <div class="text-muted">
                                        <p class="mb-1"><i class="mdi mdi-circle-medium align-middle text-primary mr-1"></i> Tentukan Tanggal Awal dan Tanggal Akhir (Tanggal Surat) atau Unit Penerima (Opsional)</p>
    ...
    <!-- scripts js -->
    <script src="<?= base_url();?>assets/back-end/js/pages/report/incoming-report.init.js"></script>
