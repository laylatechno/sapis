...
<div class="main-content">
                    ...
                    <div class="row task-dates">
                        ...
                        <div class="col-sm-3 col-3">
                            <div class="text-center mt-4">
                                <h5 class="font-size-14 mb-4"><i class="bx bx-calendar-check mr-1 text-primary"></i> No Agenda</h5>
                                <h5 name="view-InMailAgenda" class="text-muted font-size-15 mb-0"></h5>
                                <p name="view-InMailLog" class="text-muted mb-0"></p>
                            </div>
                        </div>
  ...
  <script src="<?= base_url();?>assets/back-end/js/pages/disposition/inbox-detail.init.js"></script>
