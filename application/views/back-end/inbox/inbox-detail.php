...
<div class="main-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Surat Masuk</h4>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 col-xl-4">
              <div class="card">
                  <div class="card-body">
                      <h4 class="card-title mb-4">Informasi Disposisi</h4>
                      <table class="table mb-0" style="table-layout: fixed; width: 100%">
                          <tbody>
                            <tr>
                                <th scope="row" width="30%">Batas Waktu</th>
                                <td>
                                  <div name="view-DispositionDeadline" class="text-muted text-truncate"></div>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" width="30%">Catatan</th>
                                <td style="word-wrap: break-word"><p name="view-DispositionNote" class="text-muted text-justify"></p></td>
                            </tr>
                            <tr>
                                <th scope="row" width="30%">Pendisposisi</th>
                                <td>
                                  <div name="view-DispositionUser" class="text-muted text-truncate"></div>
                                </td>
                            </tr>
                          </tbody>
                      </table>
                      <div class="mt-4">
                        <footer class="blockquote-footer font-size-12"><cite name="view-DispositionLog" title="Source Title"></cite></footer>
                      </div>
                  </div>
              </div>
          </div>
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <form id="form" class="form-horizontal needs-validation my-2" action="javascript:void(0)" method="post" novalidate>
                                  ...
                                  <div class="float-right">
                                    <button type="button" class="btn btn-info waves-effect waves-light submit-button mr-1">Kirim <i class="bx bx-send font-size-16 align-middle ml-2"></i></button>
                                  </div>
  ...
  <script src="<?= base_url();?>assets/back-end/js/pages/inbox/inbox-detail.init.js"></script>
