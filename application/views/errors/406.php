        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        <h1 class="display-2 font-weight-medium">4<i class="bx bx-buoy bx-spin text-primary display-3"></i>6</h1>
                        <h4 class="text-uppercase">Akses ditolak! Anda tidak memiliki akses untuk membaca halaman ini.</h4>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-xl-6">
                    <div>
                        <img src="<?= base_url('assets/login-page/img/error/denied-img.png')?>" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
