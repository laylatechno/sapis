! function(t, e) {
  ...
  var y, w, k = {
    ...
    S = function() {
      ...
      return a(t, [{
        ...
        value: function(t, e, i) {
          ...
          var E = T.bbox();
          if (r) {
            var I = this.graphics.drawRect(E.x - v, E.y - C, E.width + v + w, E.height + A + C, x, u, 1, f, b, p);
            z.insertBefore(I.node, T.node)
          }
    ...
    N = function() {
      ...
      return a(t, [{
        ...
        value: function() {
          ...
          i.globals.isXNumeric ? (t = i.globals.gridWidth / (o.length - 1), n = n + t / 2 + i.config.xaxis.labels.offsetX) : (t = i.globals.gridWidth / o.length, n = n + t + i.config.xaxis.labels.offsetX);
          var h = o.length;
          if (i.config.xaxis.labels.show)
            for (var c = function(s) {
                var l = n - t / 2 + i.config.xaxis.labels.offsetX,
                  c = e.axesUtils.getLabel(o, i.globals.timescaleLabels, l, s, e.drawnLabels, e.xaxisFontSize),
                  d = 28;
                i.globals.rotateXLabels && (d = 22), c = e.axesUtils.checkForOverflowingLabels(s, c, h, e.drawnLabels, e.drawnLabelsRects);
                var g = a.drawText({
                  x: c.x,
                  y: e.offY + i.config.xaxis.labels.offsetY + d,
                  text: c.text,
                  textAnchor: "middle",
                  fontWeight: c.isBold ? 600 : 400,
        ...
        value: function() {
          ...
          if (t.globals.rotateXLabels || t.config.xaxis.labels.rotateAlways)
            for (var n = 0; n < a.length; n++) {
              ...
              t.config.xaxis.labels.trim && l.forEach((function(i) {
              ...
              for (var i = t.globals.gridWidth / (t.globals.labels.length + 1), s = 0; s < a.length; s++) {
                ...
                t.config.xaxis.labels.trim && "datetime" !== t.config.xaxis.type && r.forEach((function(t) {
      ...
      return a(t, [{
        ...
        value: function(t, e) {
          var i = this.w,
            ...
            s = i.config.xaxis,
            r = Math.abs(e - t);
          return e !== -Number.MAX_VALUE && g.isNumber(e) ? a.xAxisScale = this.niceScale(t, e, r, s.tickAmount ? s.tickAmount : r < 5 && r > 1 ? r + 1 : 5) : a.xAxisScale = this.linearScale(0, 5, 5), a.xAxisScale
        }
      }, {
      ...
      return a(t, [{
        ...
        value: function() {
          ...
          if (t.minX === t.maxX) {
            ...
            } else("numeric" === e.xaxis.type || "category" === e.xaxis.type && !t.noLabelsProvided) && (t.minX = t.minX - 2, t.maxX = t.maxX + 2)
          }
    ...
    _ = function() {
      function t(i) {
        e(this, t), this.ctx = i, this.w = i.w, this.documentEvent = g.bind(this.documentEvent, this), this.windowResizeHandler = this.windowResize.bind(this)
      }
      return a(t, [{
        ...
        value: function() {
          this.w.globals.animationEnded && this.w.config.chart.redrawOnParentResize && this.windowResize()
        }
      }, {
        key: "windowResize",
        value: function() {
        ...
        value: function() {
          ...
          if (e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0) {
            ...
            var h = new D(this.dCtx.ctx),
              c = r;
            r = h.xLabelFormat(s, r, c), n = h.xLabelFormat(s, n, c), e.config.xaxis.convertedCatToNumeric && void 0 === r && e.globals.collapsedSeries.length === e.config.series.length && (n = r = "1");
      ...
      return a(t, [{
        ...
        value: function(t) {
          ...
          if (e.globals.comboBarCount > 0 && (s = e.globals.comboBarCount), e.globals.collapsedSeries.forEach((function(t) {
            ...
            var r, n;
            r = Math.abs(e.globals.initialMaxX - e.globals.initialMinX) / t, e.globals.minXDiff && e.globals.minXDiff / r > 0 && (n = e.globals.minXDiff / r), (a = n / s * parseInt(e.config.plotOptions.bar.columnWidth, 10) / 100) < 1 && (a = 1), a = a / (s > 1 ? 1 : 1.5) + 5, e.globals.barPadForNumericAxis = a
          }
          return a
        }
      }, {
    ...
    dt = function() {
      ...
      return a(t, [{
        ...
        value: function() {
          for (var t = this.w, e = new p(this.ctx), i = new M(this.ctx), a = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series"), s = 0; s < a.length; s++) {
        ...
        value: function(t) {
          ...
          if (this.yaxisLabels = this.graphics.group({
              ...
              t.forEach((function(t, a) {
                var s = new M(e.ctx).getMarkerConfig("apexcharts-marker", o, a),
        ...
        switch (t[0]) {
          ...
          case "A":
            t = (e = function(t, e) {
              ...
              s = (new SVG.Matrix).rotate(E).scale(1 / z, 1 / T).rotate(-E), R = R.transform(s), F = F.transform(s), r = [F.x - R.x, F.y - R.y], o = r[0] * r[0] + r[1] * r[1], n = Math.sqrt(o), r[0] /= n, r[1] /= n, l = o < 4 ? Math.sqrt(1 - o / 4) : 0, I === M && (l *= -1);
  ...
  return function() {
    function t(i, a) {
      e(this, t), this.opts = a, this.ctx = this, this.w = new T(a).init(), this.el = i, this.w.globals.cuid = g.randomId(), this.w.globals.chartID = this.w.config.chart.id ? this.w.config.chart.id : this.w.globals.cuid, new Tt(this).initModules(), this.create = g.bind(this.create, this)
    }
    return a(t, [{
      key: "render",
      value: function() {
        ...
        return new Promise((function(e, i) {
          if (null !== t.el) {
            ...
            "function" == typeof a && a(t, t.w), t.events.fireEvent("beforeMount", [t, t.w]), window.addEventListener("resize", t.events.windowResizeHandler), window.addResizeListener(t.el.parentNode, t.events.parentResizeCallback.bind(t.events));
      ...
      value: function() {
        ...
        })), window.removeEventListener("resize", this.events.windowResizeHandler), window.removeResizeListener(this.el.parentNode, this.events.parentResizeCallback.bind(this.events)), new Et(this.ctx).clear()
      }
    }, {
      key: "updateOptions",
      value: function(t) {
      ...
      value: function(t, e) {
        ...
        if (i) {
          ...
          var a = null;
          if (-1 !== this.publicMethods.indexOf(e)) {
